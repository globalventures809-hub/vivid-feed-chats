...
export const COUNTRIES: { code: string; name: string; flag: string }[] = [
  ...
  { code: "PS", name: "Palestine", flag: "🇵🇸" }, { code: "PA", name: "Panama", flag: "🇵🇦" },
  ...
  { code: "ST", name: "São Tomé and Príncipe", flag: "🇸🇹" }, { code: "SA", name: "Saudi Arabia", flag: "🇸🇦" },
  ...
  { code: "TR", name: "Türkiye", flag: "🇹🇷" }, { code: "TM", name: "Turkmenistan", flag: "🇹🇲" },
